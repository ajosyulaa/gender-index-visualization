function ScatterPlot(svg_elem, full_data){
    ...
    this.render_plot = function(records, indicator1, indicator2) {
		...
		svg.selectAll("circle")
        	   ...
        	   .attr("data-toggle", function(d, i) {
                	...
                	$(this).tooltip({'title': '<b>Country:</b> ' + 
                                          ...
                                          Math.round(d[indicator1] * 100) / 100 + " %" + '<br><b>y: </b>' + Math.round(d[indicator2] * 100) / 100 + "%"
                                });
                	return "tooltip";
            	})
